/*
refactor some code that manages student enrollment records for a workshop, 
from the module pattern to the namespace pattern using the `this` keyword.
*/
...
// ********************************
	...
	function notYetPaid(studentId) {
		var record = getStudentFromId.call(this, studentId);
		return !record.paid;
	}
